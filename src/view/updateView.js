...
export default function updateView(state) {
	if (state.salah.data != null) {
		let { currentDate, currentDayPrayerData, currentDayPrayerDataArray } = processTodaysDate(state.salah.data)
		console.log("GOT TODAYS DATA " + JSON.stringify({ currentDate, currentDayPrayerData, currentDayPrayerDataArray }))
